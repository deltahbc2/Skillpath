            ...
            <div className="max-w-300 mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-bold mb-3">Rutas de capacitación personalizadas</h3>
                    ...
                    <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-bold text-heading mb-3">Progreso y motivación</h3>
                    ...
                    <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:shadow-lg transition-all relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-bold mb-3">Recomendaciones Inteligentes</h3>
