        ...
        <section id="how-it-works" className="py-24 bg-white relative">
            <div className="max-w-300 mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-neutral-800 text-3xl lg:text-4xl font-bold text-heading mb-4">Capacitación personalizada en 5 pasos</h2>
                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 relative z-10">
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-neutral-800 font-bold text-heading mb-2">Asignación del Perfil</h3>
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-neutral-800 font-bold text-heading mb-2">Análisis del Perfil</h3>
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-neutral-800 font-bold text-heading mb-2">Comparación</h3>
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-neutral-800 font-bold text-heading mb-2">Brechas identificadas</h3>
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-neutral-800 font-bold text-heading mb-2">Ruta personalizada</h3>
