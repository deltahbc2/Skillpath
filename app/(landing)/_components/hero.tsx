...
const Hero = () => {
    ...
    return (
        <section className="bg-[#fafafa] w-full flex justify-center bg-[linear-gradient(to_bottom_right,rgba(48,170,133,0),rgba(48,170,133,0.22))]">
            <div className="w-full flex flex-col md:flex-row items-center justify-center max-w-300 px-8 my-16">
                <div className="order-1 md:order-0 w-full md:w-1/2 px-0 md:px-4 my-4 md:my-0">
                    ...
                    <p className="text-[20px] text-center md:text-start text-neutral-500 mb-6">Analiza tu perfil, detecta tus áreas de mejora y aprende con una ruta personalizada diseñada para impulsar tu carrera.</p>
