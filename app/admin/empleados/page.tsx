        ...
        <section className="w-full max-w-300 flex items-center justify-center py-8 px-8 mx-auto min-h-screen">
            <form className="flex w-full flex-col md:flex-row items-center justify-center gap-4">
                <div className="w-full md:w-1/2 flex justify-center mb-4 md:mb-0">
                    <div className="w-full max-w-xl h-96 md:h-120 rounded-2xl bg-neutral-200 dark:bg-neutral-800 p-4">
                        {!previewUrl ? (
                            <>
                                <label
                                    htmlFor="file"
                ...
                <div className="w-full flex flex-col md:w-1/2 md:ml-4 gap-y-4 rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50/70 dark:bg-neutral-900/50 p-5">
                    <input
                        ...
                        id="nombre"
                        name="nombre"
                        className=' placeholder:text-neutral-500 dark:placeholder:text-neutral-300 text-neutral-800 dark:text-neutral-100 border border-neutral-300 p-1 px-2 text-2xl font-semibold focus:outline-none w-full max-w-215 rounded-md'
                        placeholder="Nombre"
                    />
                    <div className="flex space-x-4 w-full">
                        <input
                            ...
                            id='email'
                            name="email"
                            className='text-lg font-semibold placeholder:text-neutral-500 dark:placeholder:text-neutral-300 text-neutral-700 dark:text-neutral-100 border border-neutral-300 p-1 px-2 focus:outline-none w-full md:w-[60%] rounded-md'
                        ...
                        <input
                            ...
                            id='telefono'
                            name="telefono"
                            className='text-lg font-semibold placeholder:text-neutral-500 dark:placeholder:text-neutral-300 text-neutral-700 dark:text-neutral-100 border border-neutral-300 p-1 px-2 focus:outline-none w-full md:w-[40%] rounded-md'
                            placeholder="Teléfono"
                        />
                    </div>

                    <select defaultValue="select" name="puesto" id="puesto" className="font-semibold text-md text-neutral-700 dark:text-neutral-300 border border-neutral-300 p-1 px-2 focus:outline-none w-full rounded-md">
                        <option value="select" disabled>Selecciona un puesto</option>
                    </select>
